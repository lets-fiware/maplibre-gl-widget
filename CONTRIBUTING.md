# Contributing to MapLibre GL widget

Thanks for checking out the MapLibre GL widget Project. We're excited to hear and learn from you. We've put together the
...
-   If you open a pull request, you must sign the
    [Individual Contributor License Agreement](https://github.com/lets-fiware/maplibre-gl-widget/blob/master/maplibre-gl-widget-individual-cla.pdf) by
...
If you'd like to contribute, start by searching through the [issues](https://github.com/lets-fiware/maplibre-gl-widget/issues) and
[pull requests](https://github.com/lets-fiware/maplibre-gl-widget/pulls) to see whether someone else has raised a similar idea or
question.
...
[Issues](https://github.com/lets-fiware/maplibre-gl-widget/issues) and [Pull Requests](https://github.com/lets-fiware/maplibre-gl-widget/pulls)
